...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    BasePlusCommissionEmployee employee2 = new BasePlusCommissionEmployee("Sue", "Smith", "222-22-2222", 3000.0, .05,
        300);
    ...
    Employees[] empArray = { employee1, employee2, employee3, employee4, employee5 };
